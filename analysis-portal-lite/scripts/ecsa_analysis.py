...
def run(input_dir: str, output_dir: str) -> dict:
    ...
    # Auto-detect delimiter from file types
    # FCD and TSV files are tab-delimited; parse_fcd_header() handles
    # header row count and column detection per-file inside run_batch()
