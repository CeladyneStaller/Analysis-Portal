...
def classify_files(folder):
    """
    Scan folder and classify files by analysis type.
...
def run_ecsa_batch(files, geo_area, loading, save_dir, stand=0):
    ...
    try:
        from ecsa_analysis import run_batch
    except ImportError:
...
def run_eis_batch(files, geo_area, save_dir, stand=0):
    ...
    try:
        from eis_analysis import run_batch
    except ImportError:
...
def run_crossover_batch(files, geo_area, membrane_thickness, save_dir, stand=0):
    ...
    try:
        from h2_crossover_analysis import run_batch
    except ImportError:
...
def run_polcurve_batch(files, geo_area, save_dir, stand=0):
    ...
    try:
        from polcurve_analysis import run_batch
    except ImportError:
